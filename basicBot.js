...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/grandrogue/basicBot/master/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            commandLiteral: "!",
            blacklists: {
                NSFW: "https://rawgit.com/grandrogue/basicBot-customization/master/blacklists/ExampleNSFWlist.json",
                OP: "https://rawgit.com/grandrogue/basicBot-customization/master/blacklists/ExampleOPlist.json"
            }
        },
        room: {
            users: [],
